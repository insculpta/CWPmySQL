<?php 
	...
	convert(varchar, absentnote.EndDate, 120)as EndDate , convert(varchar, absentnote.ApplicationDate, 120)as ApplicationDate,  absentnote.Remark,
	absentnote.Audited, absentnote.Approve FROM dbo.absentnote where absentnote.EmployeeID =(?)';
