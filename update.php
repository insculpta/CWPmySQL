...
if(($date!=null) AND ($work!=null) ){
$Sql_Query = "UPDATE test SET work = '$work', date = '$date' where id = '$id';";}
else if($date != null){
$Sql_Query = "UPDATE test SET date = '$date' where id = '$id';";}
else if($work != null){
$Sql_Query = "UPDATE test SET work = '$work' where id = '$id';";
}
