<?php 
	...
	$sql = 'SELECT OfficeID, OfficeName, convert(varchar, DateofIssue, 120)as DateofIssue FROM dbo.Office where OfficeID = (?)';
	$param = array($OfficeID);
	$result = sqlsrv_query($link,$sql,$param);		

	//$result = mysqli_query($link,"SELECT * FROM Office where OfficeID = '$OfficeID'");
